...
class OrganizationSettingsBalancePage extends StatefulWidget {
  ...
  @override
  State<OrganizationSettingsBalancePage> createState() => _OrganizationSettingsBalancePageState();
}

class _OrganizationSettingsBalancePageState extends State<OrganizationSettingsBalancePage> {
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        Formatters.formatMoney(sum: widget.org.balanceSum, currency: 'rub'),
